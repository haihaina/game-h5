<template>
  <div class="rankWrap animated fadeInLeft">
    <div class='rank'>
      ...
      <div class='second'>
        <img src='/static/img/second.png' class='second-crown' >
      ...
      <div class='first'>
        <img src='/static/img/first.png' class='first-crown' >
      ...
      <div class='third'>
        <img src='/static/img/third.png' class='third-crown' >
